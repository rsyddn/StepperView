...
class FrontCameraActivity : AppCompatActivity() {
    companion object {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnTakePict.setOnClickListener {
            val intent = Intent(this@FrontCameraActivity, FrontCameraResultActivity::class.java)
            val rand = (0 until 10).random()
            intent.putExtra(FrontCameraResultActivity.EXTRA_DATA, "URI $rand")
